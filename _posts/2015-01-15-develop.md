...
<div class="row">
  ...
  <div class="column halfx">
    ...
    <p>Check out some of the <a href="http://samples.argonjs.io/">samples</a> built with argon.js. An integration with Mozilla's A-Frame is also <a href="http://aframe.argonjs.io/">being developed</a>, demonstrating how argon.js applications can be written at a higher level of abstraction.</p>
  </div>
</div>
<div class="row">
  <div class="column halfx">
