...
<div class="row">
  ...
  <div class="column halfx">
    ...
    <p>Check out some of the <a href="http://argonjs.io/samples/">samples</a> built with argon.js. An integration with Mozilla's A-Frame is also <a href="http://argonjs.io/argon-aframe">being developed</a>, demonstrating how argon.js applications can be written at a higher level of abstraction. 
  </div>
</div>
<div class="row">
  <div class="column halfx">
