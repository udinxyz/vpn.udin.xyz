...
<div class="row">
  ...
  <div class="column halfx">
    ...
    <p>A variety of <a href="http://argonjs.io/samples/">argon sample applications</a> are available to help you get started. In addition, samples written using an integration with Mozilla's A-Frame are <a href="http://argonjs.io/argon-aframe">also available</a>, demonstrating how argon.js applications can be developed at a higher level of abstraction.</p>
  </div>
</div>
<div class="row">
  <div class="column halfx">
