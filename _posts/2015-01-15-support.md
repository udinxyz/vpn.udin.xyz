...
<div class="row">
  ...
  <div class="column halfx">
    ...
    <p>The source is available to a variety of <a href="https://github.com/argonjs/samples">argon sample applications</a> that can help you get started, in addition to samples written with <a href="https://github.com/argonjs/argon-aframe">argon-aframe</a>. These samples can be viewed at at http://argonjs.io/samples/ and http://argonjs.io/argon-aframe, respectively.</p>
  </div>
</div>
<div class="row">
  <div class="column halfx">
