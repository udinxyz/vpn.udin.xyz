...
<div class="row">
  <div class="column full">
    <h3 class="text-purple"><i class="fa fa-folder-open text-grey"></i>&nbsp;Tutorials</h3>
<p>The argon.js library, along with developer documentation, is available in the <a href="https://github.com/argonjs/argon.js">argon.js repository</a>.   
  </div>
</div>
<div class="row">
